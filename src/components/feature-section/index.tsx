    ...
    <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8`)}>
      <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
        <div className={tw(`mb-16 text-left`)}>
          <h4 className={tw(`text-base text-indigo-600 font-semibold tracking-wide uppercase`)}>Our Mission</h4>
        ...
        <p className={tw(`mt-2 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900`)}>
          ...
          <p className={tw(`text-base text-gray-600 tracking-wide uppercase`)}>- </p>
        <p className={tw(` text-gray-500 tracking-wide`)}>
