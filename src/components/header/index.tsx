  ...
  <header className={tw(headerStyle)}>
    <div className={tw(`max-w-4xl mx-auto py-16 px-14 sm:px-6 lg:px-8`)}>
      <h1 className={tw(`font-sans font-bold text-4xl md:text-5xl lg:text-8xl text-center leading-snug text-gray-800`)}>
        Impact Debate Institute
      </h1>
      <div className={tw(`max-w-xl mx-auto`)}>
        <p className={tw(`mt-10 text-gray-500 text-center text-xl lg:text-3xl`)}>
          The nation's leading virtual debate institute unrivaled in price and instruction
        </p>
      </div>
      <div className={tw(`mt-10 flex justify-center items-center w-full mx-auto`)}>
        ...
        <span className={tw(`mx-2`)}>  </span>
        <Button><Link href={'mailto:impactdebateinstitute@gmail.com?subject= Request for Information from Impact Debate&body=Please list any concerns you have below:'}>Contact Us</Link></Button>
        <span className={tw(`mx-2`)}>  </span>
